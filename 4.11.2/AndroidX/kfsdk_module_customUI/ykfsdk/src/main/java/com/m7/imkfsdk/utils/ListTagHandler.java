...
public class ListTagHandler implements Html.TagHandler {
    ...
    private static final String OL_TAG = "moorOl";
    private static final String UL_TAG = "moorUl";
    private static final String LI_TAG = "moorLi";

    /**
     * List indentation in pixels.
     */
    private static final int INDENT_PX = DensityUtil.dp2px(10);
    ...
    private static class Ul extends ListTag {
        ...
        protected Object[] getReplaces(final Editable text, final int indentation) {
            LogUtils.dTag("getReplaces","indentation:" + indentation,"text:" + text);
            ...
            return new Object[]{
                    ...
                    new MoorBulletSpan(bulletMargin,DensityUtil.dp2px(3),indentation == 1)
            };
        }
    }
